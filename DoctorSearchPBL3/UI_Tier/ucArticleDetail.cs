...
//            if (!string.IsNullOrEmpty(art.Thumbnail))
//            {
//                string imageFolder = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources_Images");
//                string imagePath = Path.Combine(imageFolder, art.Thumbnail);
...
//                        }
//                    }
//                    catch { picThumbnail.Visible = false; } // Ẩn khung ảnh nếu lỗi
//                }
//                else { picThumbnail.Visible = false; }
//            }
//            else { picThumbnail.Visible = false; }

//            // 3. TỰ ĐỘNG GIÃN CHIỀU CAO NỘI DUNG (Quan trọng)
//            // Tính toán chiều cao cần thiết để hiển thị hết chữ trong RichTextBox
//            using (Graphics g = txtBody.CreateGraphics())
//            {
//                // Thêm một khoảng đệm để không bị mất dòng cuối
...
//                txtBody.Height = size.Height + 100;
//            }

//            // Đảm bảo txtBody luôn nằm dưới ảnh
//            txtBody.Location = new Point(txtBody.Location.X, picThumbnail.Bottom + 30);
//        }

//        private void btnBack_Click(object sender, EventArgs e)
//        {
//            if (this.FindForm() is frmPatient main)
//            {
//                main.BackToHome();
//            }
//        }
